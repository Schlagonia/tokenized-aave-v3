...
def asset(tokens):
    yield project.dependencies["openzeppelin"]["4.9.5"].ERC20.at(tokens["usdc"])
...
@pytest.fixture(scope="session")
def aave():
    yield project.dependencies["openzeppelin"]["4.9.5"].ERC20.at(
...
def management(accounts):
    yield accounts["0xdE2e13f3228A8C767cE717cf269855D6A71dDE6c"]
