...
contract Setup is ExtendedTest {
    ...
    SparkLenderFactory public factory;
    //StrategyAprOracle public oracle;

    uint256 public MAX_BPS = 10_000;
    // Addresses
    address public constant LENDING_POOL = 0xC13e21B648A5Ee794902342038FF3aDAB66BE987;
    ...
    function setUp() public virtual {
        ...
        // Deploy factory
        factory = new SparkLenderFactory(management, rewards, keeper, daddy, LENDING_POOL, ROUTER, address(WETH));
